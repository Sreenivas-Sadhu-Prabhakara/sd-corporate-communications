package com.bank.bian.corporatecommunications.model;
...
/**
 * The BIAN control record for this service domain: "Communication Campaign Operating Session".
 *
 ...
 * to its asset type (Communication Campaign). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Communication Campaign Operating Session";
